...
class FaConfig {
    ...
    _autoAddCss = true;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaConfig, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaConfig, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaConfig, decorators: [{
            type: Injectable,
...
class FaIconLibrary {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaIconLibrary, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaIconLibrary, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaIconLibrary, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }] });
...
class FaStackItemSizeDirective {
     ...
     */
    stackItemSize = input('1x', ...(ngDevMode ? [{ debugName: "stackItemSize" }] : []));
    /**
     * @internal
     */
    ...
    }, ...(ngDevMode ? [{ debugName: "_effect" }] : []));
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaStackItemSizeDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.0.0", type: FaStackItemSizeDirective, isStandalone: true, selector: "fa-icon[stackItemSize],fa-duotone-icon[stackItemSize]", inputs: { stackItemSize: { classPropertyName: "stackItemSize", publicName: "stackItemSize", isSignal: true, isRequired: false, transformFunction: null }, size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaStackItemSizeDirective, decorators: [{
            type: Directive,
            args: [{
...
class FaStackComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaStackComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.0.0", type: FaStackComponent, isStandalone: true, selector: "fa-stack", inputs: { size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "classes()" } }, ngImport: i0, template: `<ng-content />`, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaStackComponent, decorators: [{
            type: Component,
            args: [{
                    selector: 'fa-stack',
                    template: `<ng-content />`,
...
class FaIconComponent {
    icon = model(...(ngDevMode ? [undefined, { debugName: "icon" }] : []));
    /**
     ...
     */
    animation = model(...(ngDevMode ? [undefined, { debugName: "animation" }] : []));
    mask = model(...(ngDevMode ? [undefined, { debugName: "mask" }] : []));
    flip = model(...(ngDevMode ? [undefined, { debugName: "flip" }] : []));
    size = model(...(ngDevMode ? [undefined, { debugName: "size" }] : []));
    pull = model(...(ngDevMode ? [undefined, { debugName: "pull" }] : []));
    border = model(...(ngDevMode ? [undefined, { debugName: "border" }] : []));
    inverse = model(...(ngDevMode ? [undefined, { debugName: "inverse" }] : []));
    symbol = model(...(ngDevMode ? [undefined, { debugName: "symbol" }] : []));
    rotate = model(...(ngDevMode ? [undefined, { debugName: "rotate" }] : []));
    fixedWidth = model(...(ngDevMode ? [undefined, { debugName: "fixedWidth" }] : []));
    transform = model(...(ngDevMode ? [undefined, { debugName: "transform" }] : []));
    /**
     * Specify the `role` attribute for the rendered <svg> element.
     *
     * @default 'img'
     */
    a11yRole = model(...(ngDevMode ? [undefined, { debugName: "a11yRole" }] : []));
    ...
    }, ...(ngDevMode ? [{ debugName: "renderedIconHTML" }] : []));
...
class FaDuotoneIconComponent extends FaIconComponent {
     ...
     * @default false
     */
    swapOpacity = input(...(ngDevMode ? [undefined, { debugName: "swapOpacity" }] : []));
    /**
     ...
     * @default 1.0
     */
    primaryOpacity = input(...(ngDevMode ? [undefined, { debugName: "primaryOpacity" }] : []));
    /**
     ...
     * @default 0.4
     */
    secondaryOpacity = input(...(ngDevMode ? [undefined, { debugName: "secondaryOpacity" }] : []));
    /**
     ...
     */
    primaryColor = input(...(ngDevMode ? [undefined, { debugName: "primaryColor" }] : []));
    /**
     ...
     * @default CSS inherited color
     */
    secondaryColor = input(...(ngDevMode ? [undefined, { debugName: "secondaryColor" }] : []));
    findIconDefinition(i) {
...
class FaLayersComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaLayersComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.0.0", type: FaLayersComponent, isStandalone: true, selector: "fa-layers", inputs: { size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null }, fixedWidth: { classPropertyName: "fixedWidth", publicName: "fixedWidth", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "classes()" } }, ngImport: i0, template: `<ng-content />`, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FaLayersComponent, decorators: [{
            type: Component,
            args: [{
                    selector: 'fa-layers',
                    template: `<ng-content />`,
...
class FaLayersTextComponent {
    ...
    size = input(...(ngDevMode ? [undefined, { debugName: "size" }] : []));
    pull = input(...(ngDevMode ? [undefined, { debugName: "pull" }] : []));
    border = input(...(ngDevMode ? [undefined, { debugName: "border" }] : []));
    inverse = input(...(ngDevMode ? [undefined, { debugName: "inverse" }] : []));
    rotate = input(...(ngDevMode ? [undefined, { debugName: "rotate" }] : []));
    fixedWidth = input(...(ngDevMode ? [undefined, { debugName: "fixedWidth" }] : []));
    transform = input(...(ngDevMode ? [undefined, { debugName: "transform" }] : []));
    renderedHTML = computed(() => {
        const params = this.buildParams();
        return this.updateContent(params);
    }, ...(ngDevMode ? [{ debugName: "renderedHTML" }] : []));
...
class FontAwesomeModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FontAwesomeModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.0.0", ngImport: i0, type: FontAwesomeModule, imports: [FaIconComponent,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FontAwesomeModule });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: FontAwesomeModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        FaIconComponent,
