...
export class ProductImageService {
  ...
  findByProductId(productId: string): Observable<ProductImageDTO[]> {
    return this.http.get<ProductImageDTO[]>(`${this.apiUrl}/product/${productId}`, this.getAuthHeaders());
  }
  ...
  setPrimary(id: string): Observable<any> {
    return this.http.patch(`${this.apiUrl}/${id}/primary`, {}, this.getAuthHeaders());
  }
